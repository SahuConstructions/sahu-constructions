  ...
  const submitLeave = async (e: React.FormEvent) => {
    ...
    if (balance) {
      ...
      if (remaining < diffDays) {
        toast.error(` Not enough ${leaveType} balance (${remaining} left)`);
        return;
      }
    }
              ...
              {filteredLeaves.length === 0 ? (
                ...
                filteredLeaves.map((l, i) => (
                  ...
                  >
                    ...
                    <td
                      className={`py-2 px-4 font-medium ${l.status === "Approved"
                        ? "text-green-600"
            ...
            filteredLeaves.map((l, i) => (
              ...
              >
                <div className="flex justify-between items-center">
                  ...
                  <span
                    className={`text-xs font-medium ${l.status === "Approved"
                      ? "text-green-600"
                      : l.status.toLowerCase().includes("reject")
                        ? "text-red-600"
                        : "text-yellow-600"
